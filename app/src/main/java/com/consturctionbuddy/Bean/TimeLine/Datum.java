...
public class Datum {
    ...
    private ArrayList<ProjectImg> mProjectImg;
    ...
    public ArrayList<ProjectImg> getProjectImg() {
        return mProjectImg;
    }

    public void setProjectImg(ArrayList<ProjectImg> projectImg) {
        mProjectImg = projectImg;
    }
