...
import com.consturctionbuddy.Bean.CalenderCollection;
...
public class CalendarAdapter extends BaseAdapter {
    ...
    public ArrayList<CalenderCollection> date_collection_arr;

    public CalendarAdapter(Context context, GregorianCalendar monthCalendar, ArrayList<CalenderCollection> date_collection_arr) {
    ...
    public void setEventView(View v, int pos, TextView txt) {
        ...
        int len = CalenderCollection.date_collection_arr.size();
        for (int i = 0; i < len; i++) {
            CalenderCollection cal_obj = CalenderCollection.date_collection_arr.get(i);
            ...
            if (len1 > pos) {
                ...
                if (day_string.get(pos).equals(date)) {
                    ...
                    v.setBackgroundResource(R.drawable.round_btn_primary);
    ...
    public void getPositionList(String date, final Activity act) {
        ...
        int len = CalenderCollection.date_collection_arr.size();
        for (int i = 0; i < len; i++) {
            CalenderCollection cal_collection = CalenderCollection.date_collection_arr.get(i);
