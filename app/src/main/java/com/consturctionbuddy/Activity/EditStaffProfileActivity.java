...
public class EditStaffProfileActivity extends AppCompatActivity {
    ...
    private CustomRegularTextView tv_click;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditStaffProfileActivity.this.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
    ...
    public void AddSignaturePopup() {
        ...
        final Button mClearButton = dialog.findViewById(R.id.clear_button);
        final Button mSaveButton = dialog.findViewById(R.id.save_button);
