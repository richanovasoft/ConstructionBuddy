...
import com.consturctionbuddy.Adapter.StaffListAdapter;
import com.consturctionbuddy.Bean.Totalstaff.TotalStaffBean;
...
public class TotalStaffActivity extends AppCompatActivity {

    private RecyclerView.LayoutManager mLayoutManager;
    private RecyclerView mRecyclerView;
    private StaffListAdapter mSiteImageAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activiry_total_staff);
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle("Total Staff");
        }
    ...
    private void startHttpRequestForServiceRequest() {
        ...
        if (internetAvailable) {
            showProgressBar();
            String baseUrl = Constant.API_TOTAL_STAFF_LIST;
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                TotalStaffBean listResponseBean = gson.fromJson(jsonResp, TotalStaffBean.class);

                                if (listResponseBean != null && listResponseBean.getmTotalStaffList() != null && listResponseBean.getStatus() == 200) {

                                    hideProgressBar();
                                    setOderList(listResponseBean.getmTotalStaffList());
                                } else {
                                    hideProgressBar();
    ...
    private void setOderList(ArrayList<TotalStaffListBean> posts) {

        if (posts.size() > 0) {
            mRecyclerView.setVisibility(View.VISIBLE);
            mTotalstaffList = posts;
            mSiteImageAdapter = new StaffListAdapter(mContext, mTotalstaffList);
